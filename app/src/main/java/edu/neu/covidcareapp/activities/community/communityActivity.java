...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(requestCode==2)
        {
            ...
            int pos = 0;
            addItem(pos,key,inputTitle,inputDesc, inputContext, date); //add a new card when clicking fab
...
//                startActivity(browserIntent);
                ...
                Object postDate = PostList.get(position).getTimeStamp();
    ...
    //addItem method
    private void addItem(int position,String postKey,String title,String description, String content, Object date) {
        //add a new card
